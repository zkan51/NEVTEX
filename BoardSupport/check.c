...
INFO("come back");         
            ...
            {
//               if(pMntBerth->pBoat->latitude)
//               {
//INFO("Come back with ll");            
                  pMntBerth->chsState  = MNTState_Monited;
                  pMntBerth->trgState  = MNTState_None;
//               }
//               else
//               {
//INFO("Come back without ll");               
//               }
            }
         }
         return FALSE;
...
//      if(pMntBerth->pBoat->latitude)
//      {
//INFO("Finally,fetch ll and drg point");      
//         pMntBerth->chsState  = MNTState_Monited;
//         pMntBerth->trgState  = MNTState_None;
//         pMntBerth->mntBoat.lt  = pMntBerth->pBoat->latitude;
//         pMntBerth->mntBoat.lg  = pMntBerth->pBoat->longitude;
//      }
      return FALSE;
   }
