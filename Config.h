...
#define ID_PORT_SITESEL	 (GUI_ID_USER + 0x10)//端口设置-站点选择
#define ID_PORT_INFOSEL	 (GUI_ID_USER + 0x11)//端口设置-信息选择

//系统设置
#define ID_SYSSET_DISP	      (GUI_ID_USER + 0x12)//显示设置
#define ID_SYSSET_ALAR	      (GUI_ID_USER + 0x13)//报警音设置
#define ID_SYSSET_KEYSOUND	  (GUI_ID_USER + 0x14)//按键音设置
#define ID_SYSSET_TIEM					  (GUI_ID_USER + 0x15)//时间设定
#define ID_SYSSET_LANGUAGE	  (GUI_ID_USER + 0x16)//语言设置
#define ID_SYSSET_ANTEN				  (GUI_ID_USER + 0x17)//天线设置
#define ID_SYSSET_SOFTUPDATE	(GUI_ID_USER + 0x18)//软件更新
#define ID_SYSSET_RESET  				(GUI_ID_USER + 0x19)//恢复出厂
#define ID_SYSSET_CHECK 					(GUI_ID_USER + 0x20)//开启自检
...
#define ID_INVERSE        (GUI_ID_USER + 0x60)//反色
#define ID_SLEEPSET       (GUI_ID_USER + 0x69)//睡眠设置
#define ID_SLEEPSET_0     (GUI_ID_USER + 0x70)//睡眠设置
#define ID_ALAR_INFOTYPE  (GUI_ID_USER + 0x61)//报警音-信息类型
#define ID_KEYSOUND       (GUI_ID_USER + 0x62)//按键音
#define ID_TIME           (GUI_ID_USER + 0x63)//时间
#define ID_LANGUAGE       (GUI_ID_USER + 0x64)//语言
#define ID_ANTEN          (GUI_ID_USER + 0x65)//天线
#define ID_SOFT           (GUI_ID_USER + 0x66)//软件更新
#define ID_RESET          (GUI_ID_USER + 0x67)//恢复出厂
#define ID_CHECK          (GUI_ID_USER + 0x68)//自检
